...
export const ACTIVITY_REGISTRY: readonly ActivityDefinition[] = [
  ...
  },
  {
    ...
    setup: [{ kind: 'prop', action: 'appear', propId: 'ledge' }], loop: [{ kind: 'animation', animationId: 'poko_peeking', safeExitMarkers: ['withdrawn'] }],
    duration: { kind: 'loop_count', min: 1, max: 1 }, interruption: interruption('deferred', 'stable.idle_front', ['withdrawn']),
