import type { RecentMemoryId, ScreenRegion, SessionMemory } from './types.js';
...
export function rememberActivity(m:SessionMemory,id:RecentMemoryId,at:number,interrupted=false):SessionMemory { return {...m,recentActivities:[...m.recentActivities,{id,completedAtMs:at,interrupted}].slice(-24)}; }
